...
//import com.dicoding.ecosorter.helper.ArticleEntity
...
//
//    fun submitList(newList: List<ArticleEntity>) {
//        articles.clear()
...
//            titleTextView.text = article.title
//            descriptionTextView.text = article.description
//            Glide.with(itemView.context).load(article.photoUrl).into(imageView)
//        }
//    }
//}